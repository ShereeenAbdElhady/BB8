...
u8 RCC_u8EnablePeripheralClock(u8 Copy_u8Peripheral , u8 Copy_u8State)
{
	...
	break;
	/****** TIMER4******/
	/*set bit 2 in APB1 peripheral clock enable register with one (TIMER4 clock enable)  */
	case RCC_u8_TIMER4 :RCC->APB1ENR.BitAccess.Bit2 = Copy_u8State;
	break;
	/****** TIMER1******/
	/*set bit 11 in APB2 peripheral clock enable register with one (TIMER1 clock enable)  */
	case RCC_u8_TIMER1 :RCC->APB2ENR.BitAccess.Bit11 = Copy_u8State;
	break;
