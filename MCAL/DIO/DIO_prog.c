...
{
	u8 Local_u8Result    = STD_TYPES_u8_ERROR_OK;
			u8 Local_u8ActualPrt = Copy_u8PinNb / 16;
			u8 Local_u8ActualPin = Copy_u8PinNb % 16;



		if((Copy_u8PinNb < DIO_u8_PIN0)  || (Copy_u8PinNb  > DIO_u8_PIN36) ||
				(Copy_u8PinValue < DIO_u8_PIN_LOW) ||
				 (Copy_u8PinValue >  DIO_u8_PIN_HIGH)){

			Local_u8Result=STD_TYPES_u8_ERROR_NOK;
				}
		...
		{
			case DIO_u8_PIN_HIGH: Local_u8Result = u8SetPin(Local_u8ActualPrt,Local_u8ActualPin); break;
			case DIO_u8_PIN_LOW : Local_u8Result = u8RstPin(Local_u8ActualPrt,Local_u8ActualPin); break;
			default         : Local_u8Result = STD_TYPES_u8_ERROR_NOK;                                           break;
		}
...
if (Copy_u8Direction == DIO_u8_PIN_INPUT_PULL_UP)
{
	...
	{
		case DIO_u8_PORT0: BITCALC_SET_BIT(DIO_u32_GPIOA->ODR.FourByteAccess, Local_u8ActualPin); break;
		case DIO_u8_PORT1: BITCALC_SET_BIT(DIO_u32_GPIOB->ODR.FourByteAccess, Local_u8ActualPin);break;
		case DIO_u8_PORT2: BITCALC_SET_BIT(DIO_u32_GPIOC->ODR.FourByteAccess, Local_u8ActualPin);break;
		case DIO_u8_PORT3: BITCALC_SET_BIT(DIO_u32_GPIOD->ODR.FourByteAccess, Local_u8ActualPin);break;
	}
}
...
else if (Copy_u8Direction == DIO_u8_PIN_INPUT_PULL_DOWN)
{
	switch (Local_u8ActualPrt)
	{
		case DIO_u8_PORT0: BITCALC_CLEAR_BIT(DIO_u32_GPIOA->ODR.FourByteAccess, Local_u8ActualPin); break;
		case DIO_u8_PORT1: BITCALC_CLEAR_BIT(DIO_u32_GPIOB->ODR.FourByteAccess, Local_u8ActualPin); break;
		case DIO_u8_PORT2: BITCALC_CLEAR_BIT(DIO_u32_GPIOC->ODR.FourByteAccess, Local_u8ActualPin); break;
		case DIO_u8_PORT3: BITCALC_CLEAR_BIT(DIO_u32_GPIOD->ODR.FourByteAccess, Local_u8ActualPin); break;
	}
...
if(Local_u8ActualPin <= 7)
{
	switch (Local_u8ActualPrt)
	{
		case DIO_u8_PORT0: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOA->CRL.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT1: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOB->CRL.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT2: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOC->CRL.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT3: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOD->CRL.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		default          : Local_u8Result = STD_TYPES_u8_ERROR_NOK;                                                break;
	}
}
...
else
{
	...
	switch (Local_u8ActualPrt)
	{
	case DIO_u8_PORT0: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOA->CRH.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT1: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOB->CRH.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT2: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOC->CRH.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		case DIO_u8_PORT3: BITCALC_ASSIGN_NIBBLE(DIO_u32_GPIOD->CRH.FourByteAccess,Local_u8ActualPin, Copy_u8Direction); break;
		default          : Local_u8Result = STD_TYPES_u8_ERROR_NOK;                                                break;
	}
}
return Local_u8Result;
